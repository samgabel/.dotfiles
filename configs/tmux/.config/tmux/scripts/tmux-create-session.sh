...
if [[ $OSTYPE == 'darwin'* ]]; then
    search_dirs=(~/Work/ShurikenTrade ~/Work/Devel ~/Projects ~/Projects/Devel ~/Projects/Boot.Dev ~/Projects/OpenSource ~/Projects/Kubernetes ~/Projects/GCP ~/Documents ~/.config)
else
    search_dirs=(~/)
fi
